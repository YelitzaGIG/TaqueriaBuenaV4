    ...
    <script>
        ...
        async function cambiarEstado(pedidoId, nuevoEstado) {
            try {
                ...
                const response = await fetch('/TaqueriaLaCruz/controlador/actualizarEstado.php', {
                    method: 'POST',
                    body: formData
                });
        ...
        function verSeguimiento(pedidoId) {
            window.open('/TaqueriaLaCruz/index.php?action=seguimiento&pedido_id=' + pedidoId, '_blank');
        }
