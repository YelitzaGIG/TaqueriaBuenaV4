...
<!--    <script>
    // ===============================
    // SIMULACIÓN DE PAGOS - MERCADO PAGO Y PAYPAL
    // ===============================
    ...
    // ===============================
    document.getElementById("btn-mercado")?.addEventListener("click", async function () {
        console.log("💳 ===== SIMULACIÓN MERCADO PAGO =====");
        ...
        try {
            // 3️⃣ CREAR PREFERENCIA (solo para obtener ID)
            ...
            // 4️⃣ RENDERIZAR BOTÓN DE MERCADO PAGO
            const mp = new MercadoPago("APP_USR-ae72e001-96d4-42df-8159-1cd12f01675d", {
                locale: "es-MX"
            });
            ...
            await bricksBuilder.create("wallet", "wallet_container", {
                initialization: {
                    preferenceId: dataMercadoPago.id,
                    redirectMode: "self"
                },
                customization: {
                    texts: {
                ...
                callbacks: {
                    ...
                    onSubmit: () => {
                        ...
                        // 🎭 SIMULACIÓN: Esperar 30 segundos y crear pedido
    ...
    document.querySelector(".paypal-btn")?.addEventListener("click", function () {
        ...
        paypal.Buttons({
            createOrder: function (data, actions) {
                console.log("📝 Creando orden PayPal (simulada)");
                return actions.order.create({
                    purchase_units: [{
                        description: "Pedido Taqueria Los de Cabeza",
                        amount: {
    ...
    //    }, 1000);
    //    
    //    // Después de 30 segundos, crear el pedido
    //    setTimeout(async () => {
    ...
    function simularPagoYCrearPedido(metodo) {
        ...
        setTimeout(async () => {
            ...
            try {
                // 1️⃣ Crear el pedido en tu base de datos
                await crearPedido();
                
                // 2️⃣ Obtener el total del carrito
                const total = parseFloat(document.getElementById("cart-total").textContent);
                
                // 3️⃣ Notificar al servidor que se completó el pago
                console.log("📤 Notificando al servidor sobre pago completado...");
                console.log("💰 Total a registrar:", total);
                
                await fetch("http://localhost:3000/pago_completado", {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({
                        metodo: metodo,
    ...
    console.log("✅ Código de simulación de pagos cargado");
    </script>-->

 <script>
 // ===============================
// MERCADO PAGO - EMBEBIDO SIN REDIRECCIÓN
// Reemplaza tu script actual de Mercado Pago
// ===============================
